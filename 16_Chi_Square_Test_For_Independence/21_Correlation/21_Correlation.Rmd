...
There are multiple instances of people giving tips of roughly the same ammount despite differences of several dollars in the size of their total bill.
...
```{r}
ggplot(state, aes(y = smoke, x = med_income)) +
    geom_point()
```
